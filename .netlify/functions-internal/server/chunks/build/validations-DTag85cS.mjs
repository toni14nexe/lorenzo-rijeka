...
import { S as withInstall, T as withNoopInstall, C as _export_sfc$1, z as buildProps, a3 as formContextKey, a4 as formItemContextKey, a2 as useFormSize, F as useNamespace, a5 as useId, a6 as refDebounced, a7 as addUnit, $ as isBoolean, a8 as getProp, a1 as debugWarn, a0 as componentSizes, B as definePropType, D as throwError, G as useResizeObserver } from './server.mjs';
...
function validateMobileNumber(mobile) {
  if (mobile) {
    const mobileRegex = /^\+?\d{1,3}[- ]?\(?\d{1,4}?\)?[- ]?\d{1,4}[- ]?\d{1,4}[- ]?\d{1,9}$/;
...
function validateAddress(address) {
  if (address) {
    const addressRegex = /^[A-Za-zČĆŽŠĐčćžšđ0-9\s\.\-\/]+(,\s?[A-Za-zČĆŽŠĐčćžšđ0-9\s\.\-\/]+)?$/;
...
export { ElForm as E, ElFormItem as a, validatePassword as b, validateMobileNumber as c, validateCountry as d, validateZipCode as e, validateAddress as f, validateFullname as g, isValuesEqual as i, validateEmail as v };
//# sourceMappingURL=validations-DTag85cS.mjs.map
