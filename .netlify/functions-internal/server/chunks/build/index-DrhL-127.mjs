...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-container" }, _attrs))} data-v-e11aabc3>`);
      if (unref(isLoading)) {
          ...
          template: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref($viewport).isGreaterOrEquals("tablet")) {
                _push2(ssrRenderComponent(_component_ElRow, { justify: "center" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<h3 class="color-primary" data-v-e11aabc3${_scopeId2}>Najnoviji poslovi</h3>`);
                    } else {
                      return [
                        createVNode("h3", { class: "color-primary" }, "Najnoviji poslovi")
                      ];
                    }
                  }),
                  _: 1
              ...
              _push2(ssrRenderComponent(_component_ElRow, { justify: "center" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h3 class="color-primary" data-v-e11aabc3${_scopeId2}>Poslovi</h3>`);
                  } else {
                    return [
                      createVNode("h3", { class: "color-primary" }, "Poslovi")
                    ];
                  }
                }),
                _: 1
        ...
        _push(ssrRenderComponent(_component_ElRow, { justify: "center" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<h3 class="color-primary" data-v-e11aabc3${_scopeId}>Poslovi</h3>`);
            } else {
              return [
                createVNode("h3", { class: "color-primary" }, "Poslovi")
              ];
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_component_ElSelect, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<!--[-->`);
                    ssrRenderList(unref(jobsCategories), (category) => {
                    ...
                    return [
                      (openBlock(true), createBlock(Fragment, null, renderList(unref(jobsCategories), (category) => {
        ...
        _push(ssrRenderComponent(_component_ElEmpty, { description: "Ups! Ovdje nema dostupnih poslova..." }, null, _parent));
        _push(`<!--]-->`);
      } else {
        _push(`<!--[-->`);
        if (unref($viewport).isGreaterOrEquals("tablet")) {
          _push(ssrRenderComponent(_component_ElRow, { justify: "center" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<h3 class="color-primary" data-v-e11aabc3${_scopeId}>Najnoviji poslovi</h3>`);
              } else {
                return [
                  createVNode("h3", { class: "color-primary" }, "Najnoviji poslovi")
                ];
        ...
        if (unref($viewport).isGreaterOrEquals("tablet")) {
          _push(ssrRenderComponent(_component_ElRow, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<!--[-->`);
                ssrRenderList(unref(newestJobs), (job) => {
                  _push2(ssrRenderComponent(_component_ElCol, {
                    key: String(job.id),
                    xs: 24,
                    sm: 8,
                    class: ["job-container", { "mt-12": unref($viewport).isLessOrEquals("tablet") }]
                  }, {
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(ssrRenderComponent(JobWidget, { job }, null, _parent3, _scopeId2));
                      } else {
                        return [
                          createVNode(JobWidget, { job }, null, 8, ["job"])
                        ];
                      }
                    }),
                    _: 2
                ...
                return [
                  (openBlock(true), createBlock(Fragment, null, renderList(unref(newestJobs), (job) => {
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/jobs/JobsPage.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e11aabc3"]]);
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: "Ovdje mo\u017Eete prona\u0107i ponudu svih na\u0161ih dostupnih objava za posao i detalje o poslu."
        },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_JobsPage = __nuxt_component_0;
      _push(ssrRenderComponent(_component_JobsPage, _attrs, null, _parent));
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/poslovi/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DrhL-127.mjs.map
